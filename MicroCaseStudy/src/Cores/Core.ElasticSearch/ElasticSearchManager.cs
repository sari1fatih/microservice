...
public class ElasticSearchManager: IElasticSearch
{
    ...
    public ElasticSearchManager(IOptions<ElasticSearchConfig> _optionsElasticSearchConfig)
    {
        SingleNodeConnectionPool pool = new(new Uri(_optionsElasticSearchConfig.Value.ConnectionString));
