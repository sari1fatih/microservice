...
namespace SaleService.Application;

public static class SaleServiceApplicationServiceRegistration
{
    public static IServiceCollection AddSaleServiceApplicationServiceRegistration(this IServiceCollection services,
